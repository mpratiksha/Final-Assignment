    ...
    return(
		...
		<div className="container">
			...
			<li><Link to='/'><span aria-hidden="true"><FaHome class="glyphicon-home"/></span>Home</Link></li>
				<li className="active">Beverages</li>
			</ol>
		</div>
	</div>
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img src="images/bv4.png" alt=" " className="img-responsive"/></a>
												<p>Patanjali</p>
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img src="images/bv7.png" alt=" " className="img-responsive"/></a>
												<p>Appy</p>
												<h4>$80.99 <span>$105.00</span></h4>
											</div>
											<div className="snipcart-details top_brand_home_details">
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img src="images/bv1.png" alt=" " className="img-responsive"/></a>
												<p>Minute Maid</p>
												<h4>$80.99 <span>$105.00</span></h4>
											</div>
											<div className="snipcart-details top_brand_home_details">
