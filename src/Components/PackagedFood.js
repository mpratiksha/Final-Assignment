    ...
    return(
		...
		<div className="container">
			...
			<li><Link to='/'><span aria-hidden="true"><FaHome class="glyphicon-home"/></span>Home</Link></li>
				<li className="active">Household</li>
			</ol>
		</div>
	</div>
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img src="images/pf2.png" alt=" " className="img-responsive"/></a>
												<p>Saffola-Gold</p>
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img src="images/pf5.png" alt=" " className="img-responsive"/></a>
												<p>Saffola-Gold</p>
												<h4>$80.99 <span>$105.00</span></h4>
											</div>
											<div className="snipcart-details top_brand_home_details">
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img src="images/pf8.png" alt=" " className="img-responsive"/></a>
												<p>Saffola-Gold</p>
												<h4>$80.99 <span>$105.00</span></h4>
											</div>
											<div className="snipcart-details top_brand_home_details">
