							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img src="images/hh3.png" alt=" " className="img-responsive"/></a>
												<p>Dosa Tawa</p>
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img src="images/hh6.png" alt=" " className="img-responsive"/></a>
												<p>Breakfast Pan</p>
												<h4>$80.99 <span>$105.00</span></h4>
											</div>
											<div className="snipcart-details top_brand_home_details">
							...
							<div className="agile_top_brand_left_grid">
								...
								<div className="agile_top_brand_left_grid1">
									<figure>
										<div className="snipcart-item block">
											<div className="snipcart-thumb">
												<a href="single.html"><img src="images/hh9.png" alt=" " className="img-responsive"/></a>
												<p>Tadka Pan</p>
												<h4>$80.99 <span>$105.00</span></h4>
											</div>
											<div className="snipcart-details top_brand_home_details">
